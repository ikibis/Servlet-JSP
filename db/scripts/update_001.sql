...
(
  ...
  country_id varchar(10)             NOT NULL default '0',
...
(
  city_id    varchar(11) PRIMARY KEY NOT NULL,
  country_id varchar(11)             NOT NULL default '0',
  region_id  varchar(10)             NOT NULL default '0',
  name       varchar(128)            NOT NULL default ''
);

INSERT INTO region
VALUES (5, 4, 0, 'Виктория'),
...
(
  country_id varchar(11) PRIMARY KEY NOT NULL,
  city_id    varchar(11)             NOT NULL default '0',
  name       varchar(128)            NOT NULL default ''
);

INSERT INTO country
VALUES (4, 0, 'Австралия'),
       (63, 0, 'Австрия'),
       (81, 0, 'Азербайджан'),
       (173, 0, 'Ангуилья'),
       (177, 0, 'Аргентина'),
